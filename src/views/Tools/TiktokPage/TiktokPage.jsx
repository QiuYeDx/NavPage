...
export default function TiktokPage() {
    ...
    const showDownloadProgress = (progress, id) => {
        notify_loading(<span>正在下载视频: <span tw={'font-mono'} style={{
        ...
        <PaddingWrapper tw={'col-span-4'}>
            ...
            {data ? <FadeInOnViewport>
                <ContentWrapper>
                    <LineWrapper>
                        <InLineTitle>
                            视频<FontAwesomeIcon icon={solid("layer-group")}
                                               tw={"text-blue-400 pl-1 pr-1 duration-500 ease-out"}/>详情
                        </InLineTitle>
                    </LineWrapper>
                    <Gap/>
                    <LineWrapper>
                        <InLineTitle
                            tw={'text-2xl font-medium flex flex-row justify-between min-w-[298px] max-w-[330px]'}>
                    ...
                    <LineWrapper tw={'mt-2'}>
                        ...
                        <MButton disabled={!finished || downloadState.get(1)} h={'36px'} w={'140px'}
                                 ...
                                 }}>
                            {
                                !finished ?
                                    ...
                                    :
                                    (downloadState.get(1) ? <>下载中...<FontAwesomeIcon icon={solid("spinner")} spin
